...
// CLASS TASK (1.Function for checking current year is leap year or not)
...
if (checkingLeapYear()) {
  console.log('The current year is "LEAP YEAR" ');
}
else {
  console.log('The current year is not "LEAP YEAR" ');
}

// CLASS TASK (2.Function for checking current year is leap year or not)

// function leapYearInNextTenYears()
// {
//   var gettingDate = new Date();
//   var nextTenYears = new Date(gettingDate.getFullYear + 10, gettingDate.getMonth(), gettingDate.getDate());
//   var leapYears = [];
//   for (var year = gettingDate.getFullYear(); year <= nextTenYears.getFullYear(); year++) {
...
//   return leapYears;
// }
// var leapYears = leapYearInNextTenYears();
// console.log(leapYears); // Prints the leap years in the upcoming next 10 years

// CLASS TASK (3.Function for generating OTP)
...
// CLASS TASK (4.Function for converting string to capital case)
...
var myString = "Hello Girl";
var capitalizedString = capitalize(myString);
console.log(capitalizedString); 

// CLASS TASK (5.Function for calculating your age)

function myAge(birthdaydate) {
  var today = new Date();
